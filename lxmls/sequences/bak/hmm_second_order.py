...
class HMM_Second_Order:
    ...
    @staticmethod
    def get_node_posteriors_aux(seq, forward, backward, node_potentials, edge_potentials, likelihood):
        H, N = forward.shape
    ...
    @staticmethod
    def get_edge_posteriors_aux(seq, forward, backward, node_potentials, edge_potentials, likelihood):
        H, N = forward.shape
